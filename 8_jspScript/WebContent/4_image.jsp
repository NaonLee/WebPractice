...
list-style:none;border-bottom: 2px solid lightgray;position: absolute;}
...
<body>
	<ul class="lst_type">
		...
		%>
			<li>
				<a href='#' style='margin-left:50px'><img src='image/snapshot.jpg' width='90' height='90' alt=''/></a>
				<a href='#'><strong>image name: snapshot <%=i %></strong></a>
